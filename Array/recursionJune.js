...
console.log("hey I am in recursion file");
...
// fibonacci series  number on n
// if n = 5 then 0 ,1,2,3,4
// 0+1+1+3+7+11 = 23
...
process.stdout.write(
  firstTerm + " " + secondTerm + " This is a stdout way to write "
);

console.log(
  `first term is ${firstTerm}  and secondterm is ${secondTerm} in backtics method of typing`
);
...
//
dskjb i  asdiugh iu hiuuh iouagisudgfi
*/
